...
- **HTML5 & CSS3** (Vanilla CSS with Glassmorphism and Custom Cyber-Neon Themes)
- **JavaScript (ES6+)** with Canvas 2D / 3D Animation Engine
- **IndexedDB & LocalStorage Engine** for offline-first resilience
